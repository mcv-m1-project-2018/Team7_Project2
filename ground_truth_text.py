     (150, 671, 1045, 772), (45, 36, 379, 92), (133, 314, 383, 358), (87, 163, 710, 248), (137, 877, 988, 986),
     (208, 25, 1195, 170), (114, 874, 1009, 975), (153, 615, 730, 700), (255, 232, 1335, 408), (356, 2229, 2740, 2525),
     (281, 2162, 2143, 2398), (278, 486, 2433, 751), (255, 12, 2210, 337), (345, 2148, 2468, 2413),
     (344, 53, 2339, 318), (408, 2181, 3623, 2566), (362, 10, 2829, 302), (411, 2334, 2854, 2625),
     (354, 260, 2453, 513), (319, 2022, 2794, 2347), (296, 2382, 2567, 2654), (380, 2960, 2367, 3225),
     (317, 170, 2160, 435), (308, 2440, 2295, 2705), (373, 300, 2816, 591), (350, 65, 2863, 385), (389, 39, 2468, 275),
     (368, 374, 2551, 579), (398, 2133, 2773, 2329), (231, 565, 2018, 770), (324, 394, 2297, 599),
     (350, 102, 2646, 338), (264, 500, 2119, 658), (252, 362, 2225, 567), (334, 500, 1929, 639), (302, 245, 2329, 450),
     ...
     (336, 1591, 2632, 1827), (370, 37, 2661, 242), (387, 61, 2420, 266), (296, 507, 2527, 712), (254, 205, 1734, 325),
     (401, 572, 2374, 777), (407, 2335, 2773, 2571), (396, 2015, 2451, 2191), (394, 433, 2367, 638),
     (250, 2499, 2019, 2638), (434, 1555, 2467, 1760), (324, 2105, 2790, 2313)]
...
def analyze_gt(data, gt):
    ...
    for im, im_name in data.database_imgs:
        ...
        image_white = cv2.inRange(hsv_image, (0, 0, 200), (180, 50, 255))/255
        image_black = cv2.inRange(hsv_image, (0, 0, 0), (180, 50, 50))/255
        ...
        centered_distance = abs(x1 - (hsv_image_big.shape[1] - x2)) / hsv_image_big.shape[1]
        centered_distances.append(centered_distance)
        ...
        centered_distance_reshape = abs(x1_big - (hsv_image_big.shape[1] - x2_big)) / hsv_image_big.shape[1]
        centered_distances_reshape.append(centered_distance_reshape)


        if (centered_distance > 5):
    ...
    print("min centered_distance " + str(min(centered_distances)))
    print("max centered_distance " + str(max(centered_distances)))
    print("mean centered_distance " + str(np.mean(centered_distances)))
    print("std centered_distance " + str(np.std(centered_distances)))

    print("min centered_distance_reshape " + str(min(centered_distances_reshape)))
    print("max centered_distance_reshape " + str(max(centered_distances_reshape)))
    print("mean centered_distance_reshape " + str(np.mean(centered_distances_reshape)))
    print("std centered_distance_reshape " + str(np.std(centered_distances_reshape)))
    ...
    plt.subplot(3, 4, 11)
    plt.title("Centered Distances")
    plt.hist(centered_distances, bins=100)
    plt.subplot(3, 4, 12)
    plt.title("Centered Distances Reshape")
    plt.hist(centered_distances_reshape, bins=100)
    plt.show()
